...
public class ShellLexer: SourceCodeRegexLexer {
  ...
  public lazy var generators: [TokenGenerator] = {
    ...
    let keywords = "exit set local if then else elif fi case esac for select while until do done in function time coproc return".components(separatedBy: .whitespaces)
