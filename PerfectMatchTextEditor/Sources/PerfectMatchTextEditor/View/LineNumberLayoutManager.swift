...
internal class LineNumberLayoutManager: NSLayoutManager {
	
  internal var lastParaLocation = 0
  internal var lastParaNumber = 0
	
  internal func _paraNumber(for charRange: NSRange) -> Int {
    ...
    #if os(macOS)
      internal override func processEditing(
  ...
  internal var gutterWidth: CGFloat = 0.0
	
  internal override func drawBackground(forGlyphRange glyphsToShow: NSRange, at origin: CGPoint) {
